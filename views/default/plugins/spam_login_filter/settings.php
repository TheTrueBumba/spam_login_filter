...
$content .= elgg_view("output/longtext", array("value" => elgg_echo("spam_login_filter:fassim_blocked_country_list:help"), "class" => "elgg-subtext"));
$content .= "</div>";
...
$content .= elgg_view("output/longtext", array("value" => elgg_echo("spam_login_filter:fassim_blocked_region_list:help"), "class" => "elgg-subtext"));
$content .= "</div>";
